...
%General settings 
k = 2; % Number of experiments to run
...
rapidSettings.experimentSettings.p_0 = [0.3, 0.001, 1.7, 1.1, 1]; %Initial parameter guesses
...
switch lower(rapidSettings.experimentSettings.optimizationAlgorithm) % use lower to add robustness
    ...
    case 'multiobj'
        rapidSettings.multiObjSettings = 'optimset(''UseParallel'',true)';
end
