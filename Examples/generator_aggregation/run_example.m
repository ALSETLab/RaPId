...
rapidSettings.experimentSettings.pathToFMUModel = 'generator_aggregation.fmu'; %FMU file name
...
rapidSettings.experimentSettings.p_0 = [0.3, 0.2, 0.0001, 1.1, 1]; %Initial parameter guess
rapidSettings.experimentSettings.p_min = [0.0001, 0.1, 0.000005, 0.1, 0.1]; %Minimum values of parameters
rapidSettings.experimentSettings.p_max = [2, 5, 0.5, 1.5,2]; %Maximum values of parameters
