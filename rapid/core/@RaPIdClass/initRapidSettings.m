...
obj.psoSettings=struct('w',0.25,'self_coeff',0.25,'social_coeff',0.25,...
    'pass_coeff',0.5,'nRandMin',8,'nb_particles',8,'fitnessStopRatio',1e-5,...
...
obj.parallelSettings=struct('parallel','optimset(''UseParallel'',''true'')','solver','fmincon');
obj.multiObjSettings='optimset(''UseParallel'',''true'')';
