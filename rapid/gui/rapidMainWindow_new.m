function varargout = rapidMainWindow_new(varargin)
% RAPIDMAINWINDOW_NEW is the main GUI Window for the RaPId Toolbox. It can be
% called directly or by calling the function runRapidGui.
%
%      rapidMainWindow_new, by itself, creates a new rapidMainWindow_new or raises the existing
%      singleton.
%
%      H = rapidMainWindow_new returns the handle to a new rapidMainWindow_new or the handle to
%      the existing singleton.
%
%      rapidMainWindow_new('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in rapidMainWindow_new.m with the given input arguments.
%
%      rapidMainWindow_new('Property','Value',...) creates a new rapidMainWindow_new or raises the
...
% Last Modified by GUIDE v2.5 20-Nov-2020 14:03:55

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @rapidMainWindow_new_OpeningFcn, ...
    'gui_OutputFcn',  @rapidMainWindow_new_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
function rapidMainWindow_new_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = rapidMainWindow_new_OutputFcn(hObject, eventdata, handles)
